...
It binds `HOST=127.0.0.1` for deployments where Cloudflare Tunnel or private networking handles inbound access. On this machine the user service runs from `/home/OPERATOR/leakrouter` and reads `/home/OPERATOR/leakrouter/.env`.
